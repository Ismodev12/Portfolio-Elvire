...
export default function Hero() {
  ...
  return (
    <section id="accueil" aria-label="Accueil — Portfolio Elvire Fadegnon, développeuse Full Stack" className="relative min-h-screen flex items-center overflow-hidden"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-28 md:pt-40 pb-16">
        ...
        <style>{`
          ...
          @media (min-width: 1024px) {
            .hero-mobile-frame { display: none !important; }
          }
        `}</style>

        {/* ── Image mobile (visible seulement sur mobile, avant le texte) ── */}
        <motion.div
        ...
        <div className="grid lg:grid-cols-[1fr_46%] gap-6 xl:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 style={{
              ...
              fontSize:'clamp(2.4rem,6.5vw,5.8rem)', letterSpacing:'-0.025em',
              lineHeight:1.08, marginBottom:'1.6rem',
            }}>
              {[
            ...
            <motion.p {...anim(0.22)} style={{ fontFamily:'DM Sans,sans-serif', fontSize:'clamp(15px,2.5vw,18px)', color: colors.textMuted, maxWidth:460, lineHeight:1.85, marginBottom:'2rem' }}>
              {t('hero.subtitle')}
            </motion.p>

            <motion.div {...anim(0.32)} style={{ display:'flex', flexWrap:'wrap', gap:12, marginBottom:'2.5rem' }}>
            ...
            <motion.div {...anim(0.42)} style={{ display:'flex', alignItems:'center', gap:28, flexWrap:'wrap' }}>
              {[
                ...
                <React.Fragment key={i}>
                  <div>
                    <p style={{ fontFamily:'Outfit,sans-serif', fontWeight:900, fontSize:'clamp(1.5rem,3vw,2rem)', color: colors.textPrimary, lineHeight:1, marginBottom:4 }}>{s.n}</p>
                    <p style={{ fontFamily:'DM Sans,sans-serif', fontSize:'13px', color: colors.textMuted }}>{s.l}</p>
                  </div>
          ...
          {/* Image desktop (visible seulement sur lg+) */}
          <motion.div
